  ...
  return (
    ...
    >
      <img
        src={imgUrl}
        alt="planet-04"
        className="absolute w-4/5 h-3/4 object-cover rounded-[24px]"
      />
      {active !== id ? (
        ...
        <div style={{marginBottom:86,}} className="absolute bottom-0 p-8 flex justify-start w-4/5 flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px]">
          <div
